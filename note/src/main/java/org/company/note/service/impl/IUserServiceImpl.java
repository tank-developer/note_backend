...
import org.company.note.service.exception.*;
import org.company.note.utils.PasswordEncryptedUtils;
...
public class IUserServiceImpl implements IUserService {
     ...
     */
    @Override
    public boolean checkPhoneExists(String email) {
        return false;
    }
    ...
    public void deleteUser(int uid) {
        // 设置状态为0，表示用户已注销
        userMapper.updateUserStatus(uid, 1,"delete","00000","0000@gmial.com");
    }
